...
public class TambahBarang extends AppCompatActivity {
    ...
    private String barangJudul, barangDesc, barangKategori, barangKuaniti, hargaAsli, diskonHarga, diskonNote;
    ...
    private void inputData() {
        ...
        barangKuaniti = kuantiti.getText().toString().trim();
    ...
    private void tambahBarang() {
        ...
        if (image_uri == null) {
            ...
            hashMap.put("barangKuantiti", ""+barangKuaniti);
