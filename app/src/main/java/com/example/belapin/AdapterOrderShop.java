...
public class AdapterOrderShop extends RecyclerView.Adapter<AdapterOrderShop.HolderOrderShop> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull HolderOrderShop holder, int position) {
        ...
        final String orderId = modelOrderShop.getPesananId();
        final String orderBy = modelOrderShop.getYangOrder(); //orderBy
        String orderCost = modelOrderShop.getCost();
        String orderStatus = modelOrderShop.getStatusOrder();
        String orderTime = modelOrderShop.getWaktoOrder();
        String orderTo = modelOrderShop.getOrderKe(); //order to
    ...
    private void loadUserInfo(ModelOrderShop modelOrderShop, final HolderOrderShop holder) {
        ...
        ref.child(modelOrderShop.getYangOrder())
